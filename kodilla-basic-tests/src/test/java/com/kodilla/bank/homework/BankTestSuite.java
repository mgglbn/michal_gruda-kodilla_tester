...
public class BankTestSuite {
    ...
    @Test
    public void shouldCalculateAverageOfWithdrawalsWhenMoreThanZero(){
        Bank bank = new Bank(cashMachines);
        cashMachines[0].withdrawal(100);
    ...
    @Test
    public void shouldCalculateAverageOfDepositsWhenZero(){
        Bank bank = new Bank(cashMachines);
        assertEquals(0,bank.getMeanWithdrawals(),0.001);
    }

    @Test
    public void shouldCalculateAverageOfDepositsWhenMoreThanZero(){
        Bank bank = new Bank(cashMachines);
        cashMachines[0].deposit(100);
